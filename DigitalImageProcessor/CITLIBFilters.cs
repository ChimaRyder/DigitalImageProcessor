...
namespace ImageProcess2
{
	...
	public class BitmapFilter
	{
		...
		public static void Sepia (Bitmap b)
		{
			...
			BitmapData bProcessed = b.LockBits(new Rectangle(0, 0, Width, Height), ImageLockMode.ReadWrite, PixelFormat.Format24bppRgb);

			int offset = bProcessed.Stride - Width * 3;

			unsafe
			{
				byte* p = (byte*)(void*)bProcessed.Scan0;
